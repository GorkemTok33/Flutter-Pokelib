        ...
        Positioned(
          ...
          child: Material(
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    buildDynamicTexts("Physical Properties", [
                      Padding(
                    ...
                    buildDynamicTexts("Previous Evolution", [
                      Padding(
                        padding: const EdgeInsets.all(8.0),
                    ...
                    buildDynamicTexts("Next Evolution", [
                      Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: widget.pokemon.prevEvolution != null
                            ? Row(
